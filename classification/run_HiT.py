...
from model.HiT import HiTClf, HiT_simply, HiT_Conv1d
...
def convert_examples_to_features(code_tokens, label, code_vocab, args, path_tokens=None, path_vocab=None):
    ...
    return InputFeatures(source_tokens, source_ids, label, processed_path_tokens, processed_path_ids)
...
def train(args, train_dataset, model, code_vocab, path_vocab, pool):
    ...
    for idx in range(args.start_epoch, int(args.num_train_epochs)):
        ...
        for step, batch in enumerate(bar):
            ...
            model.train()
            loss, __ = model([inputs, path_inputs], labels)
...
def main():
    ...
    if args.model_type == 'HiT_path_node':
        model = HiTClf([args.seq_vocab_size, args.path_vocab_size], args.cls_num, args.emb_size, args.nhead,
                       args.nhid, args.nlayers, path_nlayers=args.path_nlayers, dropout=args.dropout)
    elif args.model_type == 'HiT_simply_path_node':
        model = HiT_simply([args.seq_vocab_size, args.path_vocab_size], args.cls_num, args.emb_size, args.nhead,
                           args.nhid, args.nlayers, path_nlayers=args.path_nlayers, dropout=args.dropout)
    elif args.model_type == 'HiT_Conv1d_path_node':
        model = HiT_Conv1d([args.seq_vocab_size, args.path_vocab_size], args.cls_num, args.emb_size, args.nhead,
